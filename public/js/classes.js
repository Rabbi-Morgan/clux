        ...
        if(response.error){
          ...
          <div class="ms-3">
            <p class="fw-bold mb-1">${cls.teacher_first_name} ${cls.teacher_last_name}</p>
                ...
                <td><a class="btn btn-sm ${endDate >  new Date() ?  "btn-success": "disabled btn-secondary"}" href="https://app.learncube.com/api/virtual-classroom/class/start/?pub_key=${CLUX_PUBK}&room_token=${cls.room_token}&userid=647303" ><i class="fa fa-sign-in"></i> Enter class</a></td>
